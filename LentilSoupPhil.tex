...
\begin{itemize}
  ...
  \item 2 large tomatoes, skin removed
\end{itemize}
...
\begin{enumerate}
  ...
  \item Heat oil in a large pot, hot add cloves, chilli. Saut'{e} for 2 minutes.
  ...
  \item Cook for $1 \frac {1}{2}$ hours on a low heat until the lentils are soft.
\end{enumerate}

Finish with:

\begin{enumerate}
  \item Add butter to a saucepan over high heat.
  \item Add garlic, cumin, paprika and a pinch of salt.
  \item Once melted in, stir and turn down heat for a minute more.
